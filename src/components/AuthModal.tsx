            ...
            {authTab === 'quick_phone' && (
              <div className="space-y-3.5 animate-in fade-in duration-200">
                ...
                <div className="relative text-center my-1.5">
                  ...
                  <span className="relative bg-[#121218] px-3 text-[10px] text-slate-500 font-bold">أو</span>
                </div>
                ...
                <button
                  type="button"
                  onClick={handleGuestContinue}
                  className="w-full text-center py-2 text-slate-400 hover:text-amber-400 text-xs font-bold transition-colors block cursor-pointer"
                >
                  تخطي والدخول كزائر بدون تسجيل ←
                </button>
              </div>
            )}
